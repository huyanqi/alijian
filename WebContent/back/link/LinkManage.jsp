...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$("#insertType").html("添加友情链接");
		$("#insertType").attr("onclick","pageHref('LinkInsert.jsp?is_edit=0')");
		$("#title").html("友情链接列表");
	...
	function editModel(id){
		pageHref("LinkInsert.jsp?is_edit=1&id="+id);
	}
	
	function deleteModel(id){
		if(!confirm("确定要删除吗？")){return;}
		var path = "<%=basePath%>removeLinkById";
		var data = {"id":id};
		$.ajax({
			type : 'POST',
			data : data,
